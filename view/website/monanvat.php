...
<section id="portfolio" class="bg-light-gray">
      <div class="container">
            <div class="row">
                <div class="col-lg-4 kim-directory"><p><a href="?action=home">Trang Chủ</a> &raquo; <a href="?action=sanpham">Sản Phẩm</a> &raquo; <a href="?acton=monanvat">Món Ăn Vặt</a></p></div>
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                        ...
                        <p class="text-muted">Mã SP: BC001</p>
                         ...
                         <p class="text-muted">Thích hợp ăn chay: <i class="fa fa-leaf kim-vegeterian"></i></p>
                          <p class="text-muted">Đánh giá: <i class="fa fa-star kim-reviews"></i> <i class="fa fa-star kim-reviews"></i> <i class="fa fa-star kim-reviews"></i> <i class="fa fa-star kim-reviews"></i> <i class="fa fa-star kim-reviews"></i></p>
                        </div>
